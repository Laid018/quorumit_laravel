        ...
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                <div class="flex justify-center">
                    <svg viewBox="0 0 62 65" fill="none" xmlns="http://www.w3.org/2000/svg" class="logo h-30 w-auto bg-gray-100 dark:bg-gray-900">
                ...
                <div class="mt-16">
                    <h1 class="title text-center text-2xl text-gray-500">Application for Quorumit</h1>
                    <p class="subtitle text-center text-sm text-gray-500">
                        Is a app for authorization. 
